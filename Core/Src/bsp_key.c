...
static const X_GPIO_T s_gpio_list[HARD_KEY_NUM] = {
  {GPIOG, GPIO_PIN_8, 0},   /* K1 */
  {GPIOC, GPIO_PIN_13, 0},  /* K2 */
  {GPIOA, GPIO_PIN_0, 1},   /* K3 */
  {GPIOG, GPIO_PIN_15, 0},   /* JOY_U */
  {GPIOD, GPIO_PIN_3, 0},   /* JOY_D */
  {GPIOG, GPIO_PIN_14, 0},   /* JOY_L */
  {GPIOG, GPIO_PIN_13, 0},   /* JOY_R */
  {GPIOG, GPIO_PIN_7, 0},  /* JOY_OK */
};
