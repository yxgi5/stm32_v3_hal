...
void bsp_InitTimer(void)
{
  ...
  // SystemCoreClock 72MHz for STM32F1XX
...
void bsp_InitHardTimer(void)
{
  ...
  APB1 TIMxCLK = PCLK1 x 2 = SystemCoreClock = 72MHz;
  APB2 TIMxCLK = PCLK2 x 1 = SystemCoreClock = 72MHz;
...
//    {
//      usPeriod = 0xFFFFFFFF; // 32bit tim max count for STM32F4
//    }
//    else
//    {
